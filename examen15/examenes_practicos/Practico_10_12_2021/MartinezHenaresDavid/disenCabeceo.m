...
fprintf('- Usando el controlador PD propuesto:\n');
...
fprintf(['- El sistema es estable ya que los margenes de ganancia y ' ...
    'fase son positivos\n']);
fprintf('- Ancho de Banda %.2f rad/s.\n\n',anchoBanda);
...
fprintf(['El sistema no cumplira las especificaciones por que no tiene' ...
    ' situados los polos donde deberian estar Pd1 Y Pd2\n\n']);
...
fprintf('- Usando el compensador de adelanto con la ganancia reajustada:\n');
fprintf('- El margen de ganancia es: %.2f dB.\n',MG_dB_alt);
fprintf('- La wcg esta en: %.2f rad/s.\n',wcg_alt);
fprintf('- El margen de fase es: %.2f grados.\n',MF_alt);
fprintf('- La wcg esta en: %.2f rad/s.\n',wcf_alt);
...
respuesta = ['Vista la señal de control del sistema digitalizado usando la variante pd' ...
    ' no se logra eliminar por completo el sobre impulso, el diseño alternativo' ...
    ' con el método de cancelación cero-polo sí conseguía cumplir ante entrada' ...
    ' escalón digitalizando ese controlador podrían cumplirse las' ...
    ' especificaciones.'];

% Imprimir usando fprintf
fprintf(['Vista la señal de control del sistema digitalizado usando la variante pd\n' ...
    ' no se logra eliminar por completo el sobre impulso, el diseño alternativo\n' ...
    ' con el método de cancelación cero-polo sí conseguía cumplir ante entrada\n' ...
    ' escalón digitalizando ese controlador podrían cumplirse las\n' ...
    ' especificaciones.\n']);
