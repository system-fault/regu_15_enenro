...
fprintf(['- En ningun caso se cumplen las especificaciones\n - La amplitud' ...
...
fprintf(['● El sistema tiene un MG = infinito en los dos casos ya que la ' ...
    'Fase\n']);
fprintf(['  total del sistema controlado no disminuye en ningun momento de ' ...
    '-180\n']);
fprintf(['  grados, podrian soportar aumentos de ganancia significativos ' ...
    'sin llegar a\n']);
