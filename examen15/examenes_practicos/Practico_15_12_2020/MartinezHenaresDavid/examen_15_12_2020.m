...
fprintf(['Se ve en el grafico que no podrias situar los polos sobre el LGR\n ' ...
    'con una simple gangncia ya que las ramas estan situadas en -2 y los\n ' ...
    'polos deseados en -20, hay ue modificar el LGR para que las ramas\n ' ...
    'pasen por los polos deseados\n\n'])
...
fprintf('\n');
fprintf(['A la vista de los polos y ceros que se calculan en lazo cerrado\n ' ...
    'creo que si se cumpliran la especificaciones porque los polos deseados\n ' ...
    'parecen ser domianntes sobre el tercer polo de -47.1288 + 0i\n\n']);
...
fprintf('Periodo de muestreo h = %.8f s\n\n',h_digitalizacion);
...
fprintf(['Segun se puede ver en el grafico del analisis el MG y el MF son\n' ...
    'positivos por lo tanto el sistema es estable\n'])
